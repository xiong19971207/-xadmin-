# Generated by Django 2.2.12 on 2020-04-24 20:19
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('teacher', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='organizations.Teacher', verbose_name='老师')),
            ],
            options={
                'verbose_name': '课程信息',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('learn_times', models.IntegerField(default=0, verbose_name='学习时长(分钟数)')),
                ('course', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='courses.Course', verbose_name='关联课程')),
            ],
            options={
                'verbose_name': '课程章节',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lesson', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='courses.Lesson', verbose_name='关联章节')),
            ],
            options={
                'verbose_name': '课程视频',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('course', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='courses.Course', verbose_name='关联外键课程')),
            ],
            options={
                'verbose_name': '课程资源',
